(() => {
  ...
  const onMouseUp = () => {
    ...
    console.log(
      ...
      "to",
      placeholder.closest(".column").getAttribute('class').split(" ")[1],
      "before item",
    ...
    let order_id = movingElement.getAttribute('class').split(" ")[1];
    let order_stage = placeholder.closest(".column").getAttribute('class').split(" ")[1]
